...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val nameEditNim = view.findViewById<TextInputEditText>(R.id.textInputTextNim)


        nameEditNim.addTextChangedListener(
            object : TextWatcher {
                override fun beforeTextChanged(
                    charSequence: CharSequence, i: Int, i1: Int, i2: Int) {
                }
        ...
        val nameEditJurusan = view.findViewById<TextInputEditText>(R.id.textInputTextJurusan)


        nameEditJurusan.addTextChangedListener(
            object : TextWatcher {
                override fun beforeTextChanged(
                    charSequence: CharSequence, i: Int, i1: Int, i2: Int) {
                }
                override fun onTextChanged(charSequence: CharSequence,
                    ...
                    communicationViewModel!!.setJurusan(charSequence.toString())
                }
                override fun afterTextChanged(editable: Editable) {
                }
            })
